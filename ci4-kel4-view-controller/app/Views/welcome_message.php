...
<head>
	<meta charset="UTF-8">
	<title>SMK AS-SAABIQ SINGAPARNA</title>
...
<body>
	...
	<header>
		...
		<div class="menu">
			<ul>
				<li class="logo"><a href="https://codeigniter.com" target="_blank" style="color: #DD4814; font-weight: bold;">SMK AS-SAABIQ SINGAPARNA</a>
				</li>
				<li class="menu-toggle">
					<button onclick="toggleMenu();">&#9776;</button>
				</li>
				<li class="menu-item hidden"><a href="#">Home</a></li>
				<li class="menu-item hidden"><a href="#">Contact</a></li>
				<li class="menu-item hidden"><a href="#">About</a></li>
			</ul>
		</div>
		...
		<div class="heroe">
			...
			<h2>Selamat datang datang di website SMK AS-SAABIQ SINGAPARNA</h2>
	...
	<section>
		...
		<p>
			...
			Alhamdulillah, Puji Syukur kehadirat Allah SWT kami sudah 12 tahun melayani warga Tasikmalaya menyiapkan generasi muda angkatan kerja yang siap pakai di dunia usaha dan dunia industri. Insyaalloh kami tetap komitmen dengan program SMK BERMUTU DAN MURAH. Infrastruktur yang terus kami benahi & lengkapi untuk menunjang proses KBM yang aplikatif dan inovatif yang berbasis IT menuju smart school. Kami mengutamakan pembentukan karakter peserta didik yang akhlakul karimah, disiplin, berkarakter, mandirim kompeten, kreatif dengan kearifan budaya lokal dalam proses belajarnya. Kami ucapkan selamat bergabung untuk siswa – siswi di SMK AS-SAABIQ SINGAPARNA tempat untuk memperoleh jaminan masa depan yang lebih baik.
		</p>
	...
	<div class="further">
		...
		<section>
			...
			<p>
				sebuah jurusan yang mempelajari dan mendalami semua cara-cara pengembangan perangkat lunak termasuk pembuatan, pemeliharaan, manajemen organisasi pengembangan perangkat lunak dan manajemen kualitas.
			</p>
			...
			<p>
				Akuntansi terdiri dari pembelajaran manual dan akuntansi komputer (MYOB), dengan mempelajari pelajaran akuntansi siswa dapat mengembangkan pengetahuan dalam dunia akuntansi dan membuat buku keuangan untuk perusahaan jasa, perusahaan dagang, dan perusahaan manufaktur.
			</p>
